...
const RESTORED_OWNER_TEXT = 'Restaurar Propietario';
...
export function RestoredOwnerDialog({ customer }: { customer: Customer }) {
  ...
  const onSubmit = (values: RestoredCustomerSchemaType) => {
    if (values.confirmation !== RESTORED_OWNER_TEXT) {
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Restaurar Propietario</DialogTitle>
            <DialogDescription>
              Ingrese {RESTORED_OWNER_TEXT} para confirmar.
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        disabled={isPending}
                        placeholder={RESTORED_OWNER_TEXT}
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
