...
const RESTORED_PRIVATE_PARKING_TEXT = 'Restaurar Estacionamiento Privado';

export function RestoredPrivateParkingDialog({ customer }: { customer: Customer }) {
  ...
  const onSubmit = (values: RestoredCustomerSchemaType) => {
    if (values.confirmation !== RESTORED_PRIVATE_PARKING_TEXT) {
    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          ...
          >
            Restaurar Estacionamiento Privado
          </Button>
        </DialogTrigger>

        <DialogContent>
          <DialogHeader>
            <DialogTitle>Restaurar Estacionamiento Privado</DialogTitle>
            <DialogDescription>
              Ingrese {RESTORED_PRIVATE_PARKING_TEXT} para confirmar.
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        disabled={isPending}
                        placeholder={RESTORED_PRIVATE_PARKING_TEXT}
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
